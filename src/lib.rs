// src/lib.rs
/*
 * Core library for CoinMarketCap
 */
...
#[derive(Debug)]
pub struct CoinMarketCapProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CoinMarketCapProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CoinMarketCap processing");
    
    let mut processor = CoinMarketCapProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CoinMarketCapProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CoinMarketCapProcessor::new(false);
